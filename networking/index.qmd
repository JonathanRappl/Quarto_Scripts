...
Eine URL ist eine eindeutige Adresse, die auf eine Ressource (meistens eine Datei) im Internet verweist. Sie besteht aus mehreren Teilen, darunter das Protokoll (`http://` oder `https://`), der Domain-Name (`www.beispielseite.ch`) und der Pfad zur Datei (`/unterseite.html`).
...
3. Öffnen Sie die Datei in einem Webbrowser (z.B. Chrome, Firefox, Safari, etc.) durch Doppelklick.
:::
